...
PRODUCT_NAME := ukg_toroplus
PRODUCT_MODEL := Galaxy Nexus
PRODUCT_MANUFACTURER := Samsung
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.toroplus.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="toroplus-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="google/toroplus:4.2.2/JDQ39/573038:user/release-keys"
